...
import { idlFactory } from './upload-images-to-icp-asset.did.js';
export { idlFactory } from './upload-images-to-icp-asset.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_UPLOAD_IMAGES_TO_ICP_ASSET;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./upload-images-to-icp-asset.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the upload-images-to-icp-asset canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./upload-images-to-icp-asset.did.js")._SERVICE>}
 */
export const upload_images_to_icp_asset = createActor(canisterId);
